...
<html>
<head>
<link rel="stylesheet" href="view/videoView/video.css" type="text/css" />
<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
<script src="view/videoView/video.js"></script>
</head>
<body>
<%
...
<!-- 여기 --><source src="http://210.123.255.152:8080/file${path}" type="video/mp4"/>
        </video>
  ...
  <header class="header">
    <h1><a rel="nofollow" rel="noreferrer"href="http://tadaima.studio" title="Go to Tadaima">
