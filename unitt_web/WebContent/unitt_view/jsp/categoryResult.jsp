...
<div id="topMenu1">
	<ul>
		<li class="topMenuLi"><a class="menuLink"
				href="CategoryController?category=search_Arr_Test&select=교육">교육</a></li>
			<li class="topMenuLi"><a class="menuLink"
				href="CategoryController?category=search_Arr_Test&select=IT">IT</a></li>
			<li class="topMenuLi"><a class="menuLink"
				href="CategoryController?category=search_Arr_Test&select=스포츠">스포츠</a></li>
			<li class="topMenuLi"><a class="menuLink"
				href="CategoryController?category=search_Arr_Test&select=게임">게임</a></li>
			<li class="topMenuLi"><a class="menuLink"
				href="CategoryController?category=search_Arr_Test&select=음악">음악</a></li>
			<li class="topMenuLi"><a class="menuLink"
				href="CategoryController?category=search_Arr_Test&select=기타">기타</a></li>
		<!-- <li>|</li> -->
