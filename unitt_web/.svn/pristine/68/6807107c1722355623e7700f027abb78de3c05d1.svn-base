...
public class CategoryService_Multidimensional_Array_Test implements CommandHandler {
	...
	public String process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		CategoryDao dao = new CategoryDao();
			...
			viewPage = "/view/categoryView/categoryResult_Multidimensional_Array_Test.jsp"; // 강좌 리스트 페이지
